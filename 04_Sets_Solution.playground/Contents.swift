...
// Answer: sets are really _fast_ compared to arrays, especially when the number of items gets vary large. Its because constant time lookup and hashable values in the set unlike array where you check the values in order
